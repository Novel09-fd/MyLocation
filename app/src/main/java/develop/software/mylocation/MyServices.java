...
import develop.software.mylocation.mylocation.PostLocation;
...
@SuppressLint("NewApi")
public class MyServices extends JobService implements
    ...
    private void writeActualLocation(Location location) {
        ...
        postDataLocation("Somaddwizakaria", location.getLatitude(), location.getLongitude());
   // Toast.makeText(getApplicationContext(), "," + location.getLatitude() + ", " + location.getLongitude() + "," + time ,Toast.LENGTH_SHORT).show();
    }
    ...
    private void startJobAgain() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            JobInfo jobInfo = new JobInfo.Builder(1, componentName)
                    .setMinimumLatency(300000) //10 sec interval
    ...
    public void postDataLocation(String username, Double latitude, Double longitude) {

        apiInterface = APIClient.getClient().create(APIInterfacesRest.class);

        Call<PostLocation> call3 = apiInterface.postLoadLocation(username,latitude,longitude);
        call3.enqueue(new Callback<PostLocation>() {
            @Override
            public void onResponse(Call<PostLocation> call, Response<PostLocation> response) {

                PostLocation data = response.body();

                if (data != null) {


                    Toast.makeText(MyServices.this,"Data verhasil disimpan", Toast.LENGTH_LONG).show();
                    ...
                    try {
                        ...
                        Toast.makeText(MyServices.this, jObjError.getString("message"), Toast.LENGTH_LONG).show();
                    } catch (Exception e) {
                        Toast.makeText(MyServices.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
