package develop.software.mylocation.service;
...
public interface APIInterfacesRest {
        ...
        Call<ModelLocation> getDataLocation();
/*
        @GET("genre/all")
        Call<ModelGenre> getGenreMovie();

        @GET("rating/all")
        Call<ModelRating> getRatingMovie();
 ...
 */
        ...
        Call<PostLocation> postLoadLocation(@Field("username") String username, @Field("latitude") Double latitude, @Field("longitude") Double longitude);
